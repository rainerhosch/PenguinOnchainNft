...
describe("PengoFactory", function () {
    ...
    beforeEach(async function () {
        ...
        const PengoConverter = await hre.ethers.deployContract("PengoConverter");
        await PengoConverter.waitForDeployment();
        console.log("pengoConverter deployed to:", PengoConverter.target);
        console.log("===========================================================\n");
        ...
        const PenguinOnchain = await ethers.getContractFactory("PenguinOnchain", {
            libraries: {
                PengoConverter: PengoConverter.target,
            },
        });
    ...
    it("should return tokenURI correctly", async function () {
        ...
        const inisiate1 = await pengoNft.initializeCoordinates(part1, top_wear); //error
        ...
        const inisiate2 = await pengoNft.initializeCoordinates(part2, body_wear); //error
        ...
        const inisiate3 = await pengoNft.initializeCoordinates(part3, foot_wear); //error
        ...
        const inisiate4 = await pengoNft.initializeCoordinates(part4, eye_wear); //error
