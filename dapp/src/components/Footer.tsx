        ...
        <>
            <nav className="relative bottom-0 left-0 right-0 bg-black/50 backdrop-blur-md">
                <div className="grid grid-cols-4 gap-1 p-2">
                    <a href="https://twitter.com/PenguinOnchain" target="_blank" className="flex flex-col items-center p-2 text-white hover:text-black ">
                    ...
                    <a href="https://youtube.com/@PenguinOnchain" target="_blank" className="flex flex-col items-center p-2 text-white hover:text-black ">
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
